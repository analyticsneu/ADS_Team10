...
write.csv(output,"sampleformat.csv",na="",row.names = FALSE);

#question 2: multi-variable regression

#install.packages("leaps");
library(leaps);
prepareddataset=output[,-c(1,2,6)];
...
forecastinput$hour=forecast$Hr;
...
forecastinput$month=factor(forecastinput$month);
